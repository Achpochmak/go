...
var (
	...
	ErrInvalidPackaging    = errors.New("неправильный вид упаковки")
	ErrWeightIsTooBig      = errors.New("вес слишком большой")
	ErrWeightNotFound      = errors.New("вес не найден")
	ErrStorageTimeNotFound = errors.New("время хранения не найдено")
	ErrPriceNotFound       = errors.New("цена не найдена")
)
